            ...
            <DialogContent>
                <Grid style={{ margin: '10px 0' }} container direction="column">
                    <TextField
                        ...
                        onChange={event => {
                            setAutoFindProps({...autoFindProps, fromDate: event.target.value })
                        }}
                    />
                    <TextField
                        label="Find to date"
                        ...
                        onChange={event => {
                            setAutoFindProps({...autoFindProps, toDate: event.target.value })
                        }}
                    />
                    <TextField
                        ...
                        onChange={event => {
                            setAutoFindProps({...autoFindProps, fromTime: event.target.value })
                        }}
                    />
                    <TextField
                        label="Find to time"
                        ...
                        onChange={event => {
                            setAutoFindProps({...autoFindProps, toTime: event.target.value })
                        }}
                    />
                </Grid>
            </DialogContent>
